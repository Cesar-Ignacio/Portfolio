...
import CartContenedor from '../components/CartContenedor';
import BackgroTextura from '../icono/BackgroTextura';
    ...
    <>
      <SeccionConteiner id='tec' className='scroll-mt-[5rem] '>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 w-[100%] mt-4'>
          {/* FRONTEND */}
          {/* <div className='bg-silver-200 dark:bg-firefly-950 border-[2px] border-solid border-[#689994] rounded-lg shadow-[0px_0px_10px_#125d67] z-20 p-4 relative overflow-hidden'>
            <div>
            ...
            <svg className='absolute top-[1rem]  right-[-5rem]  -z-10 w-[25rem] stroke-silver-300 dark:stroke-silver-500 rotate-[45deg] transition-all duration-300 ease-linear drop-shadow-[0px_0px_10px_#689994]' viewBox="0 0 24 24" fill="transparent" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* <div className='bg-silver-200 dark:bg-firefly-950 border-[2px] border-solid border-[#689994] rounded-lg shadow-[0px_0px_10px_#125d67] z-20 p-4 relative overflow-hidden '>
            ...
            <svg className='absolute top-[-5rem]  right-[-8rem]  -z-10 w-[25rem] stroke-silver-300 dark:stroke-silver-500  rotate-[140deg] transition-all duration-300 ease-linear drop-shadow-[0px_0px_10px_#689994]' viewBox="0 0 24 24" fill="transparent" xmlns="http://www.w3.org/2000/svg">
              <path d="M15 5L9.5 5C8.56538 5 8.09808 5 7.75 5.20096C7.52197 5.33261 7.33261 5.52197 7.20096 5.75C7 6.09808 7 6.56538 7 7.5C7 8.43462 7 8.90192 7.20096 9.25C7.33261 9.47803 7.52197 9.66739 7.75 9.79904C8.09808 10 8.56538 10 9.5 10L18.5 10C19.4346 10 19.9019 10 20.25 9.79904C20.478 9.66739 20.6674 9.47803 20.799 9.25C21 8.90192 21 8.43462 21 7.5C21 6.56538 21 6.09808 20.799 5.75C20.6674 5.52197 20.478 5.33261 20.25 5.20096C19.9704 5.03954 19.6139 5.00778 19 5.00153" stroke-width="1.5" stroke-linecap="round" />
              <path d="M7 16.5C7 15.5654 7 15.0981 7.20096 14.75C7.33261 14.522 7.52197 14.3326 7.75 14.201C8.09808 14 8.56538 14 9.5 14H15.5C16.4346 14 16.9019 14 17.25 14.201C17.478 14.3326 17.6674 14.522 17.799 14.75C18 15.0981 18 15.5654 18 16.5C18 17.4346 18 17.9019 17.799 18.25C17.6674 18.478 17.478 18.6674 17.25 18.799C16.9019 19 16.4346 19 15.5 19H9.5C8.56538 19 8.09808 19 7.75 18.799C7.52197 18.6674 7.33261 18.478 7.20096 18.25C7 17.9019 7 17.4346 7 16.5Z" stroke-width="1.5" />
              <path d="M3 14L3 2M3 22L3 18" stroke="" stroke-width="1.5" stroke-linecap="round" />
            </svg>
          ...
          {/* RECURSOS */}
          {/* <div className='bg-silver-200 dark:bg-firefly-950 border-[2px] border-solid border-[#689994] rounded-lg shadow-[0px_0px_10px_#125d67] z-20 p-4 relative overflow-hidden md:col-span-2'>
            ...
            <svg className='absolute top-[0rem]  right-[-7rem]  -z-10 w-[25rem] stroke-silver-300 dark:stroke-silver-500 rotate-[220deg] transition-all duration-300 ease-linear drop-shadow-[0px_0px_10px_#689994] ' viewBox="0 0 24 24" fill="transparent" xmlns="http://www.w3.org/2000/svg">
              <path d="M15 5L9.5 5C8.56538 5 8.09808 5 7.75 5.20096C7.52197 5.33261 7.33261 5.52197 7.20096 5.75C7 6.09808 7 6.56538 7 7.5C7 8.43462 7 8.90192 7.20096 9.25C7.33261 9.47803 7.52197 9.66739 7.75 9.79904C8.09808 10 8.56538 10 9.5 10L18.5 10C19.4346 10 19.9019 10 20.25 9.79904C20.478 9.66739 20.6674 9.47803 20.799 9.25C21 8.90192 21 8.43462 21 7.5C21 6.56538 21 6.09808 20.799 5.75C20.6674 5.52197 20.478 5.33261 20.25 5.20096C19.9704 5.03954 19.6139 5.00778 19 5.00153" stroke-width="1.5" stroke-linecap="round" />
              <path d="M7 16.5C7 15.5654 7 15.0981 7.20096 14.75C7.33261 14.522 7.52197 14.3326 7.75 14.201C8.09808 14 8.56538 14 9.5 14H15.5C16.4346 14 16.9019 14 17.25 14.201C17.478 14.3326 17.6674 14.522 17.799 14.75C18 15.0981 18 15.5654 18 16.5C18 17.4346 18 17.9019 17.799 18.25C17.6674 18.478 17.478 18.6674 17.25 18.799C16.9019 19 16.4346 19 15.5 19H9.5C8.56538 19 8.09808 19 7.75 18.799C7.52197 18.6674 7.33261 18.478 7.20096 18.25C7 17.9019 7 17.4346 7 16.5Z" stroke-width="1.5" />
              <path d="M3 14L3 2M3 22L3 18" stroke="" stroke-width="1.5" stroke-linecap="round" />
            </svg>
