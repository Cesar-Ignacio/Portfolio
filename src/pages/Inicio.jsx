...
const Inicio = () => {
  return (
    <div className='grid grid-cols-2 h-[80vh] p-3 rounded-[2rem]'>
      <div className='justify-self-center self-center text-silver-50  tracking-[1px]'>
        <h1 className='text-[4.2rem] text-slate-900 dark:text-silver-50 font-bold'>Cesar Aquino</h1>
      ...
      <div className=' flex justify-center items-center'>
        <div className='w-[80%] rounded-[50%] overflow-hidden border-[1px] border-white border-solid  shadow-[0px_0px_20px] shadow-white'>
