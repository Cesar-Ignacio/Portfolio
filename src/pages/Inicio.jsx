...
const Inicio = () => {
  ...
  return (
    ...
    <SeccionConteiner id={'home'} className='scroll-mt-[5rem] grid  md:grid-cols-2 md:h-[32rem]'>
      {/* Efecto en pantalla */}
      <Spotlight className="-top-40 left-0 md:left-60 md:-top-20" fill='#088c96' />

      {/* Presentacion */}
      <div className='justify-self-center self-center text-silver-950 dark:text-silver-100 tracking-[1px] relative z-20 md:col-start-1 md:col-end-2  flex flex-col gap-5'>
      ...
      {/* Avatar sm*/}
      <div className='flex  items-center justify-self-center row-start-1 md:invisible md:col-start-2 md:col-end-3  md:pb-[1rem] lg:pb-[0rem] ' >
        <Avatar className='border-[3px] border-white   shadow-shark-900 dark:shadow-fountain-blue-300  shadow-[0px_0px_10px]   w-[12rem] h-[12rem] md:w-[17rem] md:h-[17rem] lg:w-[20rem] lg:h-[20rem] z-20 '>
